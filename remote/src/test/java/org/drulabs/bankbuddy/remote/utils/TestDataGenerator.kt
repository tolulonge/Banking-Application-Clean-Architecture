package org.drulabs.bankbuddy.remote.utils
...
class TestDataGenerator {
    ...
    companion object {
        ...
        fun generateTransactions(): List<TransactionNetwork> {
            val t1 = TransactionNetwork(
